...
function DiffView({ oldContent, newContent }: { oldContent: string; newContent: string }) {
  ...
  return (
    <div className="bg-[#1B2028] text-gray-100 dark:text-gray-300 p-4 rounded-lg font-mono text-sm overflow-x-auto">
      ...
      <DialogContent className="max-w-4xl w-full h-[85vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto border-t border-gray-200 dark:border-[#111827] mt-4 p-6 bg-slate-100 dark:bg-[#020203]">
          <div className="max-w-4xl mx-auto">
            <div className="dark:bg-[#111827] rounded-lg shadow-sm border border-gray-200 dark:border-[#111827] p-6"></div>
