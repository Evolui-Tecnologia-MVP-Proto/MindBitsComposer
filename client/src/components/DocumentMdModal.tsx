        ...
        <tbody>
          {diffLines.map((line, index) => (
            <tr key={index} className={getLineStyle(line.type)}>
              <td className="pr-4 text-[#1B2028] dark:text-gray-400 text-right select-none align-top bg-transparent dark:bg-[#787A7C]" style={{minWidth: '24px', maxWidth: '24px', width: '24px'}}>
                {line.lineNumber || ''}
              </td>
              <td className="pr-2 text-[#1B2028] dark:text-gray-300 text-center select-none align-top bg-transparent dark:bg-[#787A7C]" style={{minWidth: '24px', maxWidth: '24px', width: '24px'}}>
                {getLinePrefix(line.type)}
              </td>
              <td className="text-[#1B2028] dark:text-gray-300 whitespace-pre-wrap break-words pl-2 bg-transparent dark:bg-[#787A7C]">
                {line.content || '\u00A0'}
              </td>
            </tr>
          ))}
      ...
      <DialogContent className="max-w-4xl w-full h-[85vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto border-t border-gray-200 dark:border-[#111827] mt-4 p-6 bg-slate-100 dark:bg-[#020203]">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-[#1B2028] rounded-lg shadow-sm border border-gray-200 dark:border-[#111827] p-6">
