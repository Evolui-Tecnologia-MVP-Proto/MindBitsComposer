                    ...
                    <div className="space-y-4">
                      {Object.entries(groupFieldMappings()).map(([groupKey, groupData]) => {
                        ...
                        return (
                          ...
                          >
                            <CollapsibleTrigger className="flex items-center justify-between w-full p-3 text-left bg-gray-50 dark:bg-[#1E293B] hover:bg-gray-100 dark:hover:bg-[#374151] rounded-lg border dark:border-gray-600 transition-colors">
                                ...
                                {isNested ? (
                                  ...
                                  <div className="space-y-3">
                                    {Object.entries(subGroups).map(([sectionKey, sectionData]) => (
                                      ...
                                      >
                                        <CollapsibleTrigger className="flex items-center justify-between w-full p-2 text-left bg-blue-50 dark:bg-[#1E293B] hover:bg-blue-100 dark:hover:bg-[#374151] rounded border border-blue-200 dark:border-gray-600 transition-colors">
                                          <div className="flex items-center gap-2">
