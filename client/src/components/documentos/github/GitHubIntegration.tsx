...
export function GitHubIntegration() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-14rem)] bg-white dark:bg-[#0F172A] overflow-hidden">
      <div className="bg-white dark:bg-[#0F172A] rounded-lg border dark:border-[#374151] p-6 h-full flex flex-col overflow-hidden">
        ...
        <div className="border-t dark:border-[#374151] pt-6 bg-white dark:bg-[#0F172A] p-4 rounded-lg flex-1 overflow-hidden" style={{ maxHeight: 'calc(100vh - 22rem)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="bg-white dark:bg-[#1F2937] p-4 rounded-lg flex flex-col h-full overflow-hidden">
              ...
              <div className="overflow-y-auto space-y-3" style={{ maxHeight: 'calc(100vh - 28rem)' }}>
