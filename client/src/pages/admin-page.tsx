          ...
          <TabsContent value="integracao-monday" className="slide-in">
            <div className="bg-white shadow-sm rounded-lg p-6">
              ...
              <div className="space-y-6">
                ...
                {/* Detalhes do Mapeamento Selecionado */}
                {selectedMapping && (
                  <div className="border rounded-md p-4 mt-6">
                    <h4 className="text-base font-medium mb-4 flex items-center justify-between">
                      <span>Detalhes do Mapeamento: {selectedMapping.name}</span>
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex items-center"
                    ...
                    <div className="mb-6">
                      <h5 className="text-sm font-medium mb-2">Informações do Quadro</h5>
                      <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <dt className="text-xs text-gray-500">ID do Quadro</dt>
                          <dd className="font-mono text-sm bg-gray-100 p-1 rounded inline-block mt-1">{selectedMapping.boardId}</dd>
                        </div>
                        <div>
                          <dt className="text-xs text-gray-500">Última Sincronização</dt>
                          <dd className="text-sm mt-1">
                            {selectedMapping.lastSync ? (
                              format(new Date(selectedMapping.lastSync), 'dd/MM/yyyy HH:mm', { locale: ptBR })
                            ) : (
                              <span className="text-gray-400">Nunca</span>
                            )}
                          </dd>
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <dd className="text-sm mt-1">{selectedMapping.description || "-"}</dd>
                        </div>
                      </dl>
                    </div>
                    
                    <div>
                      <h5 className="text-sm font-medium mb-2">Colunas Disponíveis</h5>
                      {isLoadingColumns ? (
