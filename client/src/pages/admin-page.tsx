        ...
        <DialogContent className="sm:max-w-[700px]">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="filtros" className="py-4">
              {!selectedMapping ? (
                <div className="text-center py-6">
                  <p className="text-gray-500">Salve o mapeamento primeiro para configurar filtros.</p>
                </div>
              ) : (
                <div className="space-y-6">
                  <div className="text-sm text-gray-600 mb-4">
                    Configure filtros para sincronizar apenas os itens que atendem aos critérios especificados.
                  </div>
                  
                  {/* Filtro por Status */}
                  <div className="space-y-3">
                    <h4 className="font-medium text-sm">Filtro por Status</h4>
                    <div className="border rounded-lg p-4 bg-gray-50">
                      ...
                      <Select disabled>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="stuck">Bloqueado</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
                    ...
                    <div className="border rounded-lg p-4 bg-gray-50">
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        <Label htmlFor="date-filter" className="text-sm">
                          Sincronizar apenas itens recentes
                        </Label>
                      </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="font-medium text-sm">Filtro por Responsável</h4>
                    <div className="border rounded-lg p-4 bg-gray-50">
                      <div className="flex items-center space-x-2 mb-3">
                        <input 
                          type="checkbox" 
                          ...
                          className="rounded border-gray-300"
                        />
                        <Label htmlFor="person-filter" className="text-sm">
                          Filtrar por pessoas específicas
                        </Label>
                      </div>
                      <Input 
                  ...
                  {/* Filtro Avançado */}
                  <div className="space-y-3">
                    <h4 className="font-medium text-sm">Filtro Avançado</h4>
                    <div className="border rounded-lg p-4 bg-gray-50">
                      <div className="flex items-center space-x-2 mb-3">
                        <input 
                          type="checkbox" 
                      ...
                      <Textarea 
                        placeholder="Ex: column_value('status') = 'Done' AND created_at > '2024-01-01'"
                        className="w-full h-20 text-sm font-mono"
                        disabled
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        Use sintaxe do Monday.com para filtros complexos
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="border-t pt-4">
                    <h4 className="font-medium text-sm mb-2">Resumo dos Filtros Ativos</h4>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                      <p className="text-sm text-blue-800">
                        <span className="font-medium">Status:</span> Nenhum filtro ativo
                      </p>
                      <p className="text-sm text-blue-600 mt-1">
                        Todos os itens do quadro serão sincronizados
                      </p>
                    </div>
                  </div>
                </div>
